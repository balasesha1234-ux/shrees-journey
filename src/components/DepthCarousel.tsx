...
export interface DepthCarouselProps {
  ...
  className?: string;
  renderCardContent?: (item: DepthCarouselItem, index: number) => React.ReactNode;
}
...
export const DepthCarousel: React.FC<DepthCarouselProps> = ({
  ...
  useEffect(() => {
    // Wheel navigation is disabled by default to allow smooth scrolling inside fan message cards
    const el = rootRef.current;
    if (!el || !cfgRef.current.enableWheel) return;
