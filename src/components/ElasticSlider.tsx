...
export const ElasticSlider: React.FC<ElasticSliderProps> = ({
  ...
  isStepped = false,
  stepSize = 1,
  leftIcon = <VolumeX className="w-5 h-5 text-[#e5c158]" />,
  rightIcon = <Volume2 className="w-5 h-5 text-[#e5c158]" />,
  onVolumeChange,
  style = {},
}) => {
  return (
        ...
        >
          <motion.div
            style={{
              ...
              height: useTransform(scale, [1, 1.15], [8, 14]),
              marginTop: useTransform(scale, [1, 1.15], [0, -3]),
              marginBottom: useTransform(scale, [1, 1.15], [0, -3]),
            }}
