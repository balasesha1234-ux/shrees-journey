...
export const WebThreads: React.FC<WebThreadsProps> = ({
  ...
  const mouseRef = useRef({ enabled: true, strength: 0.82 });
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uSpeed: { value: 0.45 },
        uThreadCount: { value: 8 },
        uFrequency: { value: 5.0 },
        uSpread: { value: 0.18 },
        uTaper: { value: 2.5 },
        uPosition: { value: 0.53 },
        uFanMode: { value: 0 },
        uGlow: { value: 0.021 },
        uFalloff: { value: 0.57 },
  ...
  return <div ref={containerRef} className={`web-threads-container ${className}`.trim()} style={style} />;
};
